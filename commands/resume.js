...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      if (!queue.paused) {
        return interaction.reply({ content: 'gada yang bisa dipause!!', ephemeral: true });
      }
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(success ? '**The music springs back to life!!**' : 'nahkan error: gabisa ngelanjutin musiknya')
